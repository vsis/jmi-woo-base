...
function optionsframework_options() {
 ...
 'desc' => '<h2 style="color: #FFF !important;">' . esc_attr__( 'Upgrade to Premium Theme & Enable Full Features!', 'esell' ) . '</h2>
	...
	$options[] = array(
		...
		'type' => 'heading');	
	$options[] = array(
		'name' => __('News Ticker', 'esell'),
		'desc' => __('Enable or disable News Ticker on Front Page', 'esell'),
		'id' => 'esell_newsticker',
		'std' => 'on',
		'type' => 'radio',
		'options' => array(
	...
	$options[] = array(		
		'desc' => __( 'News Ticker Name.', 'esell' ),
		'id' => 'esell_menumain',
		'std' => 'News Updates',
		'class' => 'mini',
		'type' => 'text'
	...
	if ( $options_categories ) {
		$options[] = array(
			'desc' => __( 'Passed an array of categories with cat_ID and cat_name', 'esell' ),
			'id' => 'tickercategory',
			'type' => 'select',
	...
	$options[] = array(		
		'desc' => __( '<b>Pro Version have more features like : Number of post & color control.</b>', 'esell' ),		
		'type' => 'info'
	);
		$options[] = array(
	...
	$options[] = array(
		'name' => __('Light box Open Images', 'esell'),
		'desc' => __('Enable or Disable Gallery Light box ', 'esell'),
		'id' => 'esell_woolightbox',
		'std' => 'on',
		'type' => 'radio',
		'options' => array(
						'on' => __('Enable','esell'),
	...
	$options[] = array(
	'name' => __('Zoom Single Product Image', 'esell'),
		'desc' => __('Enable or Disable Zoom Feature', 'esell'),
		'id' => 'esell_woozoom',
		'std' => 'off',
		'type' => 'radio',
		'options' => array(
	...
	$options[] = array(
		'name' => __('Slider Feature on Product Images', 'esell'),
		'desc' => __('Enable or Disable Slider Feature', 'esell'),
		'id' => 'esell_wooslider',
		'std' => 'off',
		'type' => 'radio',
		'options' => array(
