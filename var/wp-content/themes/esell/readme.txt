...
Read Documentation : http://www.insertcart.com/esell-wordpress-theme-documentation/
...
* Search box place holder added
* Comment reply button added
= 1.3.3.1 =
* Woocomemrce CSS issue fixed
* Removed default checkout breadcrumb 

= 1.3.3 =
* Added Smoothscroll
* Added Sidebar into frontpage
* Image auto flip on woocommerce
* Product Variation css fixed
